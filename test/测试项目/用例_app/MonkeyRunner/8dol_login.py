...
# @Last Modified time: 2016-07-22 14:33:33

#执行   monkeyrunner 8dol_login.py
...
path='/Users/weige/Desktop/qita/monkey/picture/'
logpath="/Users/weige/Desktop/qita/monkey/log/"
#python中获取当前运行的文件的名字
...
#device=MonkeyRunner.waitForConnection(5,'192.168.57.101:5555')
...
device.startActivity(component='com.ndol.sale.starter/.patch.ui.user.login.LoginActivity')
MonkeyRunner.sleep(2)
#打印操作信息
log.write("启动app……\n")
#截图
...
#保存截图
result.writeToFile(path+"登录页面".decode('utf-8')+now+'.png','png')
# #点击搜索款的位置坐标。
